...
import { SiteRouteName, SiteRoutePath, siteRoutePaths } from '@meldekort/common/siteRoutePaths';
import { Forside } from '@components/forside/Forside';
import { InnsendteMeldekort } from '@components/innsendte/InnsendteMeldekort';
import { Steg3_Deltakelse } from '@components/fyll-ut/steg-3-deltakelse/Steg3_Deltakelse';
import { Steg1_Fravær } from '@components/fyll-ut/steg-1-fravær/Steg1_Fravær';
import { Steg4_Oppsummering } from '@components/fyll-ut/steg-4-oppsummering/Steg4_Oppsummering';
import { Steg5_Kvittering } from '@components/fyll-ut/steg-5-kvittering/Steg5_Kvittering';
import { Steg2_Lønn } from '@components/fyll-ut/steg-2-lønn/Steg2_Lønn';
import { KorrigerMeldekortSendInn } from '@components/korrigerMeldekort/send-inn/KorrigerMeldekortSendInn';
