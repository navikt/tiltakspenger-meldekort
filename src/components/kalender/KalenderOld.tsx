import { KalenderUkeOld } from './KalenderUkeOld';
import classNames from 'classnames';
import { formatterDato, Ukedager } from '@utils/datetime';
import { getISOWeek } from 'date-fns';
import { useMeldekortUtfylling } from '@context/meldekort-utfylling/useMeldekortUtfylling';

import style from './KalenderOld.module.css';

type Props = {
    erUtfylt?: boolean;
};

export const KalenderOld = ({ erUtfylt = false }: Props) => {
        ...
        <div className={classNames(style.ytreKontainer, erUtfylt && style.erUtfylt)}>
            ...
            >
                ...
                <tbody className={classNames(style.ukerKontainer)}>
                    <KalenderUkeOld meldekortUke={forsteUke} readonly={erUtfylt} />
                    <KalenderUkeOld meldekortUke={andreUke} readonly={erUtfylt} />
                </tbody>
            </table>
        </div>
    );
