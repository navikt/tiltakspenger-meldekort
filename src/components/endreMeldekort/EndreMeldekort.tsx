...
const EndreMeldekort = (props: { meldekort: MeldekortUtfylling }) => {
    ...
    return (
        <div>
            ...
            <VStack gap="8">
                ...
                <Accordion>
                    <Accordion.Item>
                        ...
                        <Accordion.Content>
                            ...
                            <ul>
                                <li>
                                    Hvis du får lønn for arbeid som er en del av tiltaket ditt, skal
                                    du registrere det som lønn. Arbeid er en del av tiltaket når
                                    dette er en avtalt aktivet. Det gjelder uansett om du har
                                    arbeidet hele dagen eller bare noen timer. Tiltakspenger fra Nav
                                    regnes ikke som lønn.
                                </li>
                                <li>Du kan ikke få tiltakspenger for dager du får lønn.</li>
                                <li>
                                    Har du arbeidet i stedet for å delta på tiltaket, skal du føre
                                    “annet fravær” fra tiltaket i forrige steg.
                                </li>
                                <li>
                                    Hvis du er usikker på hva du skal fylle inn i meldekortet, ta
                                    kontakt med Nav.
                                </li>
                            </ul>
                        </Accordion.Content>
                    ...
                    <Accordion.Item>
                        ...
                        <Accordion.Content>
                            ...
                            <ul>
                                <li>
                                    Du skal velge «syk» hvis du har vært for syk til å kunne delta
                                    på tiltaksdagen. Du kan ha rett til tiltakspenger når du er syk.
                                    Det er derfor viktig at du melder om dette.
                                </li>
                                <li>
                                    Du får utbetalt full stønad de 3 første dagene du er syk. Er du
                                    syk mer enn 3 dager, får du utbetalt 75 % av full stønad resten
                                    av arbeidsgiverperioden. En arbeidsgiverperiode er på til sammen
                                    16 virkedager.
                                </li>
                                <li>
                                    Du må ha sykmelding fra lege for å ha rett på tiltakspenger i
                                    mer enn 3 dager.
                                </li>
                            </ul>
                            ...
                            <ul>
                                <li>
                                    Du skal velge «sykt barn eller syk barnepasser» hvis du ikke
                                    kunne delta på tiltaksdagen fordi barnet ditt eller barnets
                                    barnepasser var syk.
                                </li>
                                <li>
                                    Det er de samme reglene som gjelder for sykt barn/barnepasser
                                    som ved egen sykdom. Det vil si at du har rett til full
                                    utbetaling de tre første dagene og 75 % resten av
                                    arbeidsgiverperioden.
                                </li>
                                <li>
                                    Du må sende legeerklæring for barnet ditt eller bekreftelse fra
                                    barnepasseren fra dag 4 for å ha rett på tiltakspenger i mer enn
                                    3 dager.
                                </li>
                            </ul>
                        </Accordion.Content>
                    ...
                    <Accordion.Item>
                        ...
                        <Accordion.Content>
                            ...
                            <ul>
                                <li>
                                    Du kan ha rett til tiltakspenger selv om du har hatt fravær. Det
                                    gjelder hvis fraværet skyldes aktiviteter som du har avtalt med
                                    veilederen din.
                                </li>
                                <li>
                                    Godkjente årsaker til fravær, som fortsatt gir deg
                                    tiltakspenger, er for eksempel:
                                    <ul>
                                        <li>jobbintervju</li>
                                ...
                                <li>
                                    Ta kontakt med veilederen din for å dokumentere årsaken til
                                    fraværet og få det godkjent.
                                </li>
                            </ul>
                ...
                <MeldekortUkeBehandling meldekort={props.meldekort} />
                ...
                <VStack gap="2">
                    <Button
                        ...
                        onClick={() => {
                            navigate(
                                getPath(siteRoutes.endreMeldekortOppsummering, {
...
export default EndreMeldekort;

export const MeldekortUkeBehandling = (props: { meldekort: MeldekortUtfylling }) => {
    const dagerUke1 = props.meldekort.dager.slice(0, 7);
    const dagerUke2 = props.meldekort.dager.slice(7, 14);
                ...
                <VStack gap="4">
                    {dagerUke1.map((dag) => (
                        <Select
                            ...
                            value={dag.status}
                            onChange={(e) => {
                                console.log(`Endrer status for ${dag.dato} til ${e.target.value}`);
                            }}
                        >
                            {getDagStatusOptions()}
                        </Select>
